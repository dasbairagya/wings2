...
NavBar should present in all the pages other than the Sign-In and Sign-Up pages.

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            

NavBar should have a link, that is, to  Sign-in.

 

Use components like NavBar component, Card component from reactstrap.
...
Use bootstrap, css, reactstrap for styling.
